<x-layouts.dashboard :title="$title" :breadcrumbs="$breadcrumbs">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" method="POST" action="{{ route('stok.update', $transaksi->id) }}"
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" name="kodeTransaksi"
                            value="{{ old('kodeTransaksi', $transaksi->kode_transaksi) }}"
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <input type="number" name="jumlahBarang" value="{{ old('jumlahBarang', $transaksi->jumlah) }}"
