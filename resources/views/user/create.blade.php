            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('user.store') }}"
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <input type="text" name="namaPengguna" value="{{ old('namaPengguna') }}"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <input type="email" name="emailPengguna" value="{{ old('emailPengguna') }}"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <input type="text" name="usernamePengguna" value="{{ old('usernamePengguna') }}"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <select name="levelPengguna" class="form-control @error('levelPengguna') is-invalid @enderror"
                            ...
                            <option value="Owner" {{ old('levelPengguna' == 'Owner' ? 'selected' : '') }}>
                                Owner
                            </option>
                            <option value="Op-Gudang" {{ old('levelPengguna' == 'Op-Gudang' ? 'selected' : '') }}>
                                Op-Gudang
                            </option>
                        </select>
                        @error('levelPengguna')
